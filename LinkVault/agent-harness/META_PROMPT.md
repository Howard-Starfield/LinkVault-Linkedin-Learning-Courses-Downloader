...
- Next integration work should implement deterministic UI coverage for download lifecycle ordering: multiple courses should preserve queue order and expose per-course progress without live LinkedIn calls.
